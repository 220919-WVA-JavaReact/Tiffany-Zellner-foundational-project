...
public class TicketDAOImpl implements TicketDAO {
        ...
        try (Connection conn = ConnectionUtil.getConnection()) {
            ...
            if ((rs = stmt.executeQuery()) != null){
                ...
                while(rs.next()) {
                    ...
                    Ticket ticket = new Ticket(id, amount, description, receivedStatus, username);
    ...
    @Override
    public Ticket changeTicketStatus(String status, int id) {
        Ticket ticket = new Ticket();
        try(Connection conn = ConnectionUtil.getConnection()){
            String sql = "UPDATE tickets SET status = ? WHERE id = ? RETURNING *";
            ...
            if ((rs = stmt.executeQuery()) != null){
                ...
                ticket = new Ticket(amount, description, username);
            }
        } catch(SQLException e){
            e.printStackTrace();
        }
